public class Testklasse {
    public static void main(String[] args) {
        // Der komplette bisherige Ablauf wird in einen try-Block gepackt, da nun
        // mehrere Methoden (Date.init, Agent-Konstruktor, Ticket-Konstruktor,
        // addAgent/addCustomer/addTicket/addCategory, ...) fachliche Ausnahmen
        // (TicketingException und Unterklassen) werfen können. Tritt im normalen
        // Ablauf eine solche Ausnahme auf, wird sie hier zentral abgefangen und
        // ausgegeben - das Programm stürzt nicht ab.
        try {
            Date date1 = new Date();
            Date date2 = new Date();
            Date date3 = new Date();
            ...
            // Agent-Konstruktor prüft jetzt das Support-Level (1 oder 2) und kann
            // eine InvalidSupportLevelException werfen.
            ...
            // Ticket-Konstruktor prüft jetzt, dass das Fälligkeitsdatum nicht vor dem
            // Erstellungsdatum liegt, und kann eine InvalidDateRangeException werfen.
            ...
            // addAgent/addCustomer/addTicket/addCategory können jetzt eine
            // DuplicateIdException werfen, falls die ID bereits vergeben ist.
            ...
            // ===== Kapazitätsgeprüfte Agentenzuweisung (Aufgabe 3) =====
            // Wirft eine CapacityExceededException, falls agent1 bereits zu viele
            // offene Tickets bearbeitet.
            ticketList.assignAgent(ticket1, agent1);
            System.out.println("Ticket 1 wurde " + agent1.getName() + " zugewiesen.");

        } catch (TicketingException e) {
            // Zentrales Auffangen aller fachlichen Ausnahmen aus diesem Programmablauf.
            System.out.println("Fachlicher Fehler im Programmablauf: " + e.getMessage());
        }
    }
}
