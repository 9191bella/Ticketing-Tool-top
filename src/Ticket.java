...
public class Ticket {
    ...
    public Ticket(int id, String title, String description, Category category, Status status, Date createdAt, Date updatedAt, Date dueDate, Customer createdBy, Agent resolvedBy){
        this.id = id;
        this.title = title; 
